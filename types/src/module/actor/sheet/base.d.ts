...
export declare abstract class ActorSheetPF2e<TActor extends ActorPF2e> extends ActorSheet<TActor, ItemPF2e> {
    ...
    protected override: any;
    _onSortItem(event: ElementDragEvent, itemSource: ItemSourcePF2e): Promise<ItemPF2e[]>;
    ...
    protected override: any;
    _onDropItem(event: ElementDragEvent, data: DropCanvasItemDataPF2e): Promise<ItemPF2e[]>;
    protected override: any;
    _onDropFolder(_event: ElementDragEvent, data: DropCanvasData<"Folder", FolderPF2e>): Promise<ItemPF2e[]>;
    /**
    ...
    protected override: any;
    _renderInner(data: Record<string, unknown>, options: RenderOptions): Promise<any>;
    protected override: any;
    _getSubmitData(updateData?: DocumentUpdateData<TActor>): Record<string, unknown>;
}
