...
import { ArmorPF2e, PhysicalItemPF2e } from "@item";
...
export declare abstract class CreaturePF2e extends ActorPF2e {
    ...
    protected override: any;
    _preUpdate(changed: DeepPartial<this["data"]["_source"]>, options: CreatureUpdateContext<this>, user: UserPF2e): Promise<void>;
}
