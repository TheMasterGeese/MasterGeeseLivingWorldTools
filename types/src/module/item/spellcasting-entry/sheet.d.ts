...
declare class SpellPreparationSheet extends ActorSheet<ActorPF2e, ItemPF2e> {
    ...
    protected override: any;
    _onDropItemCreate(itemSource: ItemSourcePF2e | ItemSourcePF2e[]): Promise<ItemPF2e[]>;
    ...
    protected override: any;
    _renderInner(data: Record<string, unknown>, options: RenderOptions): Promise<JQuery>;
}
