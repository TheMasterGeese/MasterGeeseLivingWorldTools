...
export declare class WeaponDamagePF2e {
    static calculateStrikeNPC(weapon: any, actor: NPCPF2e, traits: TraitViewData[] | undefined, statisticsModifiers: Record<string, DeferredModifier[]>, modifierAdjustments: Record<string, ModifierAdjustment[]>, damageDice: Record<string, DamageDicePF2e[]>, proficiencyRank: number | undefined, options: string[] | undefined, rollNotes: Record<string, RollNotePF2e[]>, strikeAdjustments: StrikeAdjustment[]): DamageTemplate;
    static calculate(weapon: WeaponData, actor: CharacterPF2e | NPCPF2e, traits: TraitViewData[] | undefined, statisticsModifiers: Record<string, DeferredModifier[]>, modifierAdjustments: Record<string, ModifierAdjustment[]>, damageDice: Record<string, DamageDicePF2e[]>, proficiencyRank: number | undefined, options: string[] | undefined, rollNotes: Record<string, RollNotePF2e[]>, weaponPotency: PotencySynthetic | null, striking: Record<string, StrikingSynthetic[]>, strikeAdjustments: StrikeAdjustment[]): DamageTemplate;
