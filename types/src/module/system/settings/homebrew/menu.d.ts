...
export declare class HomebrewElements extends SettingsMenuPF2e {
    ...
    static override: any;
    readonly SETTINGS: readonly ["creatureTraits", "featTraits", "languages", "magicSchools", "spellTraits", "weaponCategories", "weaponGroups", "baseWeapons", "weaponTraits", "equipmentTraits"];
    ...
    get settings(): Record<ConfigPF2eHomebrewRecord, PartialSettingsData>;
    override: any;
    ...
    protected override: any;
    _updateObject(_event: Event, data: Record<ConfigPF2eHomebrewRecord, HomebrewTag[]>): Promise<void>;
